...
const UploadPage = () => {
   ...
   return (
      <div
         className={cn(
            "relative w-full h-full flex-1 my-16 rounded-xl lg:rounded-2xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 flex flex-col justify-center items-center",
            ...
            <Dropzone
               ...
               {({ getRootProps, getInputProps }) => (
                  <div
                     ...
                     <div className="flex flex-col justify-center mb-2 text-sm text-zink-700">
                        {isUploading ? (
